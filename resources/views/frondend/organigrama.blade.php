                    ...
                    <div class="row">
                        <div class="col-sm-12 wow animate fadeInLeft">
                            ...
                            <div class="c-content-title-1">
                                <h3 class="c-font-uppercase c-font-bold">ORGANIGRAMA</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <p>A continuación se muestra el organigrama de la empresa URANOS: </p>
                            
                        </div>
                        <div class="col-sm-12 wow animate fadeInLeft">
                        <img src="{{ asset('public/assets/base/img/content/team/organigrama.png')}}" class="img-responsive c-overlay-object" alt="">
                        </div>
                    </div>
                </div>
            </div>
